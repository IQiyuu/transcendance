    ...
    */
    ...
    async registerGame() {
        try {
            ...
            const winner = this.score_left.textContent === "11" ? this.right_player : this.left_player;
            const loser = winner == this.left_player ? this.right_player : this.left_player;
            const loser_score = this.score_left.textContent === "11" ? this.score_right.textContent : this.score_left.textContent;
